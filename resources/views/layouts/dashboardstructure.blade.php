...
<head>
  ...
  <link rel='shortcut icon' type='image/x-icon' href='{{asset('../assets/img/favicon.ico0')}}' />
        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="dashboard"> <img alt="image" src="../assets/img/logo.png" class="header-logo" /> <span
                class="logo-name">Logistic</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown {{'dashboard' == request()->path()?'active':''}}">
            ...
            <li class="dropdown {{Request::is('employee')? 'active' : null}}">
